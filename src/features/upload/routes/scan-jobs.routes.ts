...
import { ScanJobRepository } from '../../upload/repositories/scan-job.repository';
import { ChunkRepository } from '../../files/repositories/chunk.repository';
...
export function createScanJobRoutes(
  ...
  router.post('/:id/retry', async (req, res, next) => {
    try {
      ...
      if (job.fileId) {
        const { FileRepository } = await import('../../files/repositories/file.repository');
